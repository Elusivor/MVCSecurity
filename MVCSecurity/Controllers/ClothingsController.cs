...
namespace MVCSecurity.Controllers
{
    ...
    public class ClothingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Description,Size,CanDryClean,FirstProduced")] Clothing clothing)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Description,Size,CanDryClean,FirstProduced")] Clothing clothing)
        {
            if (ModelState.IsValid)
            {
